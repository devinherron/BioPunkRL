...
class Entity:
    ...
    def move_astar(self, target, entities, game_map):
        ...
        if not tcod.path_is_empty(my_path) and tcod.path_size(my_path) < 25:
            ...
            # Keep the old move function as a backup so that if there are no paths (for example another monster blocks a
            # corridor) it will still try to move towards the player (closer to the corridor opening)
